...
/**
 * Generic HTTP client for the CloudStub REST API. Knows only how to call routes and read JSON — it
 * has no knowledge of any specific service.
 */
public class ApiClient {
    ...
    public JsonNode getStatus() throws CloudStubUnavailableException {
    ...
    public Result call(String method, String path, Map<String, String> queryParams)
            throws CloudStubUnavailableException {
        ...
        try {
            ...
            throw new CloudStubUnavailableException(baseUrl);
        } catch (IOException | InterruptedException e) {
            // A mid-flight transport failure is, for a CLI, indistinguishable from "not running".
            throw new CloudStubUnavailableException(baseUrl, e);
        }
    }
