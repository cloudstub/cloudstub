 ...
 * ./<module-name>}).
 *
 * <p>{@code --core-version} — {@code cloudstub-core} version for the generated {@code build.gradle}
...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(
                "  2. Publish cloudstub-core to your local Maven repo: gradle publishToMavenLocal");
        System.out.println(
    ...
    private static void usage() {
        System.err.println(
                "Usage: java -jar cloudstub-codegen.jar --model <path-or-url> [--output <dir>] [--core-version <version>] [--validate] [--verbose]");
        System.err.println(
        ...
        System.err.println(
                "  --core-version <version>      cloudstub-core version (default: "
