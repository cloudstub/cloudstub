 ...
 */
public class CloudStubResponseTransformer implements ResponseTransformerV2 {

    public static final String NAME = "cloudstub-response";

    /**
     * Prefix shared with {@link WireMockStubRegistrar} stub names: {@code cloudstub:<id>:<key>}.
     */
    static final String STUB_NAME_PREFIX = "cloudstub:";

    private static final Logger log = LoggerFactory.getLogger(CloudStubResponseTransformer.class);
    ...
    public CloudStubResponseTransformer(
