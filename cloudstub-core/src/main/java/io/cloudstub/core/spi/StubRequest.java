 ...
 *
 * <p>This is the only request abstraction in CloudStub's public SPI. It exposes just what a module
 ...
 * type. The implementation lives in {@code cloudstub-core}'s internal package and adapts the
