...
class JsonFieldTest {
    ...
    private static final class ProbeService implements CloudStubService {
        @Override
        ...
        private static void echo(CloudStubContext ctx, String target, String path) {
            ctx.registrar()
                    .registerJsonTargetStub(
                            ...
                            (req, store) -> {
                                ...
                                return StubResponse.of(
                                        200, "text/plain", value == null ? "<null>" : value);
                            });
        }
    }
